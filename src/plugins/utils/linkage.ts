...
import { evaluators } from '@zebras/noco-core/evaluators';
import { uid } from '@zebras/noco-core/utils';
import _ from 'lodash';
import { VariableOption, VariablesContextType } from '../types/linkage';
import { conditionAnalyses } from './linkage_condition';
import { REGEX_OF_VARIABLE_IN_EXPRESSION } from './isVariable';
...
export function getFieldNameByOperator(operator: ActionType) {
  switch (operator) {
    case ActionType.Required:
    case ActionType.InRequired:
      return 'required';
